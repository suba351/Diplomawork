...
def system(y, t):
    ...
    if etta - u1*f1 - u2*f2 - f0_kappa0_k0[2] > 0:
        dydt = [d_etta, vect_plus[0][0] - (matr_plus[0][0] * etta + matr_plus[0][1] * f1 + matr_plus[0][2] * f2),
        ...
        dydt = [d_etta, vect_minus[0][0] - (matr_minus[0][0] * etta + matr_minus[0][1] * f1 + matr_minus[0][2] * f2),
